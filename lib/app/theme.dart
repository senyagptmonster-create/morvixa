...
class AppTheme {
  static const Color cBg = Color(0xFFF6FAF7);
  static const Color cSurface = Color(0xFFFFFFFF);
  static const Color cEdge = Color(0xFFD2EBD9);
  static const Color cAccent = Color(0xFF15803D);
  static const Color cAccent2 = Color(0xFF4ADE80);
  static const Color cInk = Color(0xFF14532D);
